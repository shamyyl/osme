...
var moduleMethods = {
    ...
    writeSync: function (fileName, text, callback) {
        fs.writeFileSync(fileName, text, 'utf8', function (err) {
            if (err) {
                throw err;
            }
            if (callback) {
...
var executer = new (function (limit) {
    var requestPool = [];
    var requestCount = 0;
...
exports.writeSync = moduleMethods.writeSync;
